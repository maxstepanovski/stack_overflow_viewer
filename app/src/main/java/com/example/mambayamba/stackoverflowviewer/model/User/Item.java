...
public class Item {
     ...
     */
    public Item(BadgeCounts badgeCounts, Integer accountId, Boolean isEmployee, Integer lastModifiedDate, Integer lastAccessDate, Integer age, Integer reputationChangeYear, Integer reputationChangeQuarter, Integer reputationChangeMonth, Integer reputationChangeWeek, Integer reputationChangeDay, Integer reputation, Integer creationDate, String userType, Integer userId, Integer acceptRate, String location, String websiteUrl, String link, String profileImage, String displayName) {
